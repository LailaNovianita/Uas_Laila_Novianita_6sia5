...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS - laila Novianita(6SIA5)'),
        ),
        body: LoginPage(),
      ),
    );
...
class LailaDataTable extends StatefulWidget {
  _LailaDataTableState createState() => _LailaDataTableState();
}

class _LailaDataTableState extends State<LailaDataTable> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Laila Novianita - 6SIA5'),
      ),
